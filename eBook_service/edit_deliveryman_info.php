<?php
require_once "controllers/editControllerDeliveryman.php";
	
	require_once "db_connect.php";
    $userID = $_SESSION['id'];
	$sql1 = "SELECT * FROM deliveryman_info WHERE id='$userID'";
	$userData = get($sql1);
	$userData = $userData[0];
...
<html>
	...
	<fieldset align="center">
		<legend><h1><b>Edit Deliveryman Profile</b></h1></legend>
		...
		<table align="center">
				...
				<tr>
					<td><span><b>Username</b> : <b><?=$userData['uname']?></b></span></td>
		...
		<br><center><input type="submit" name="updateDetails" value="Update"> &nbsp; <a href="Home_Delivery.php".php">Home</a> &nbsp; <a href="deliveryman_profile_info.php">Back</a></center>
