...
<script>
	...
	function checkUsername(e){
        ...
        xhttp.open("GET","checkusernamedelivery.php?uname="+e.value,true);
	...
	function checkEmail(e){
		...
		//ajax
		var xhttp = new XMLHttpRequest();
        xhttp.open("GET","checkemaildeliveryman.php?email="+e.value,true);
		xhttp.onreadystatechange=function(){
			if(this.readyState == 4 && this.status == 200){
				//when server respond
				var rsp = this.responseText;
				...
				if(rsp == "false" ){
					...
					document.getElementById("err_email").innerHTML = "User Exists";
