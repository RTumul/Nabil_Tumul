<?php
	require_once "controllers/loginControllerSeller.php";
	      ...
	      <div class="logindiv">
		      ...
		      <table align="center">
				  ...
				  <tr>
		            ...
		            <td><h1 align="center" style="font-family:verdana;">Seller Login</h1></td>
			      </tr>
			  </table>
			  <form action="" method="post" onsubmit="return validate()">
				  <table align="center">
						<tr>
						   ...
						   <td><input class="my-font my-text-field" type="text" value="<?php echo $uname;?>" placeholder="username" id="uname" name="uname">
						   <br><span id="err_uname"><?php echo $err_uname;?></span>
						</td>
					    </tr>
					    <tr>
						   <td><span class="my-font">Password: </span></td>
						   <td><input class="my-font my-text-field" type="password" placeholder="password" id="pass" name="pass">
						   <br><span id="err_pass"><?php echo $err_pass;?></span></td>
					    </tr>
					    <tr>
